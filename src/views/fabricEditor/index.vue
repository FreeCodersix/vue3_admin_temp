...
<script name="fabricEditor" setup>
import {defineAsyncComponent,reactive,onMounted,provide } from "vue"
...
const previewCurrent = defineAsyncComponent(()=>import('./components/previewCurrent.vue'))
...
const dragMode = defineAsyncComponent(()=>import('./components/dragMode.vue'))
...
const svgEl = defineAsyncComponent(()=>import('./components/svgEl.vue'))
...
const fontTmpl = defineAsyncComponent(()=>import('./components/fontTmpl.vue'))
// 功能组件
// const { CanvasEventEmitter } = defineAsyncComponent(()=>import('./utils/event/notifier'))
import { CanvasEventEmitter } from './utils/event/notifier'
// const { downFile } = defineAsyncComponent(()=>import('./utils/utils')
